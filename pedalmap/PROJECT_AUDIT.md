# PROJECT_AUDIT — PedalMap

**Fecha:** 2026-08-09  
**Repositorio:** `raycbn/Projects` (rama base: `master`)  
**Estado:** Greenfield — no existe aplicación PedalMap aún  
...
| Código reutilizable para PedalMap | **Ninguno** |

**Conclusión:** PedalMap debe construirse desde cero. El proyecto de gastos personales debe **conservarse intacto** (no destruir ni mezclar). PedalMap vivirá en su propio directorio (propuesta: `pedalmap/`).
...
| Área | Actual | Relevante para PedalMap |
|------|--------|--------------------------|
...
|---|----------|-----------|--------|
| 1 | Repo sin app PedalMap | Bloqueante | Scaffold completo |
...
| 8 | Repo llamado `Projects` (genérico) | Info | PedalMap como subproyecto |
...
| **Crear** | Nuevo directorio `pedalmap/` (o raíz dedicada si se prefiere repo split) |
...
1. Crear `pedalmap/` scaffold (Vite + React + TS + Tailwind)
