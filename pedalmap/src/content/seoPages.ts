...
export const seoPages: SeoPageContent[] = [
  {
    ...
    body: [
      'PedalMap te permite crear una ruta ciclista eligiendo un punto de salida y un destino sobre el mapa. El motor de routing calcula un recorrido adecuado para bicicleta usando datos abiertos.',
